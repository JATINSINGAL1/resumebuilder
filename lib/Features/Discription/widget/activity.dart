...
class ClubCredentials extends StatelessWidget {
  ClubCredentials({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    var controller = Get.put(Activity());
    return SimpleDialog(
        title:
          ...
          ElevatedButton.icon(
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  controller.add(controller.organizationname.text,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // organization
                  ETextFormField("Organization Name",
                      controller.organizationname, null, 1),
